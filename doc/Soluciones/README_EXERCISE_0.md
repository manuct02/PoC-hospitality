...
- Se escribe la query [aquí](http://localhost:8001/)
...
El tester del ejercicio 0 contiene 4 verificaciones que en este caso se pasan satisfactoriamente.

```bash
python3 ./ai_agents_hospitality-api/test_exercise_0.py
```

- Lista todos los hoteles y dónde están.
![alt text](image-2.png)

- Cuál es la dirección del primer hotel?
![alt text](image-4.png)

- Planes disponibles.
![alt text](image-5.png)

- Sobre las habitaciones de los hoteles listados.
